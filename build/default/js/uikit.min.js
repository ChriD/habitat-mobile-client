...
!function (t, e) {
  ...
  function Z(t, e, i) {
    if (k(e)) for (var n in e) Z(t, n, e[n]);else {
  ...
  function et(t, e) {
    for (var i = 0, n = [e, "data-" + e]; i < n.length; i++) if (Q(t, n[i])) return Z(t, n[i]);
  }
  ...
  function ve(t, e) {
    if (t && 1 === t.nodeType) for (e(t), t = t.firstElementChild; t;) ve(t, e), t = t.nextElementSibling;
  }
  ...
  function ki(e, i, n) {
    var r = {};
    if (x(i) && (i = i.options), i.extends && (e = ki(e, i.extends, n)), i.mixins) for (var t = 0, o = i.mixins.length; t < o; t++) e = ki(e, i.mixins[t], n);
  ...
  Wi.util = Object.freeze({
    ...
    t.prototype._init = function (t) {
      (t = t || {}).data = function (t, e) {
        ...
        }, {}) : void 0 : i) for (var o in i) D(i[o]) ? delete i[o] : i[o] = r[o] ? d(r[o], i[o]) : i[o];
        return i;
      ...
      t && t.forEach(function (t) {
        if (h(t, "handler")) f(i, t);else for (var e in t) f(i, t[e], e);
      });
    ...
    methods: {
      ...
      _toggleElement: function (t, e, i) {
        ...
        var r,
            ...
            p,
            m,
            g = (x(i) ? i : !1 !== i && this.hasAnimation ? this.hasTransition ? (c = (h = this).isToggled, u = h.duration, d = h.initProps, f = h.hideProps, p = h.transition, m = h._toggle, function (t, e) {
      ...
      handler: function () {
        this.tracker.init(), this.toggle && (xe(this.toggle.$el, this.cls), Z(this.toggle.$el, "aria-expanded", "true")), function () {
          ...
          Ki = !0, Tt(document, "click", function (t) {
            ...
            if (!n) for (; Xi && Xi !== e && !St(i, Xi.$el) && (!Xi.toggle || !St(i, Xi.toggle.$el));) (e = Xi).hide(!1);
          });
        }();
      }
    }, {
        ...
        var r = function () {
          ...
          if (n.toggle = e || n.toggle, n.clearTimers(), !n.isActive()) if (i && Xi && Xi !== n && Xi.isDelaying) n.showTimer = setTimeout(n.show, 10);else {
            if (n.isParentOf(Xi)) {
              ...
              Xi.hide(!1);
            } else if (Xi && !n.isChildOf(Xi) && !n.isParentOf(Xi)) for (var t; Xi && Xi !== t && !n.isChildOf(Xi);) (t = Xi).hide(!1);
  ...
  var dn = {
    ...
    update: {
      read: function () {
        ...
        if (this.expand) t = Qe(window) - (fn(document.documentElement) - fn(this.$el)) - e || "";else {
  ...
  var Tn = {
    ...
    connected: function () {
      zn[this.cacheKey] ? En(this.$el, zn[this.cacheKey] || this.dataSrc, this.dataSrcset, this.sizes) : this.isImg && this.width && this.height && En(this.$el, function (t, e, i) {
        ...
        if (i) {
          for (var r; r = Cn.exec(i);) if (!r[1] || window.matchMedia(r[1]).matches) {
    ...
    update: [{
      ...
      read: function (o) {
        ...
        o.active = !1, this.targets.every(function (t, e) {
          ...
          if (l <= a) for (var r = s.targets.length - 1; e < r; r--) if (ai(s.targets[r])) {
            t = s.targets[r];
            break;
          }
  ...
  var ir,
    ...
    methods: {
      ...
      show: function (t) {
        for (var e, i = this, n = this.toggles.length, r = this.index(), o = 0 <= r, s = "previous" === t ? -1 : 1, a = ne(t, this.toggles, r), l = 0; l < n; l++, a = (a + s + n) % n) if (!ft(i.toggles[a], ".uk-disabled, [disabled]")) {
          e = i.toggles[a];
          break;
        }
    ...
    computed: {
      props: function (f, p) {
        ...
        return Mr.reduce(function (t, e) {
          ...
          if (e.match(/^bg/)) if (Me(p, "background-position-" + e[2], ""), n = Me(p, "backgroundPosition").split(" ")["x" === e[2] ? 0 : 1], m.covers) {
        ...
        if (t.active = this.matchMedia, t.active) {
          ...
          if (n && n.naturalWidth) {
            ...
            this.bgProps.forEach(function (t) {
              ...
              if (n.match(/%$|0px/)) {
                if (s < i) h[o] = u[o] + i - s;else if (i < s) {
                  var a = parseFloat(n);
  ...
  var Rr = {
    ...
    computed: {
      ...
      maxIndex: function () {
        ...
        for (var t = Lr(this.list), e = this.length; e--;) if (Fr(this.list.children[e], this.list) < t) return Math.min(e + 1, this.length - 1);
    ...
    methods: {
      reorder: function () {
        ...
        if (Me(this.slides, "order", ""), !this.finite) {
          ...
          }), this.center) for (var t = this.slides[n], e = Wr(this.list).width / 2 - Wr(t).width / 2, r = 0; 0 < e;) {
